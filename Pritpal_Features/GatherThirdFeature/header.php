...
<head>
    ...
    <link href="../master_stylesheet.css" rel="stylesheet">
</head>
<body>
<div class="container" id="wrapper">
    <header>
        <div class="row" id="header">
            ...
            <div class="col-xs-2 col-xs-offset-1"><a href="#"><img src="../images/gather_logo.png" id="logo"></a></div>
    ...
    <section class="row" id="banner">
        <div class="col-xs-12">
            <img src="../images/main_image_notext.png" id="main" class="img-responsive" />
            <div id="main_message">
