  ...
  <body>
	<div class="container" id="wrapper">
		...
		<div class="row" id="header">
			...
			<div class="col-xs-2 col-xs-offset-1"><a href="#"><img src="Styling/images/gather_logo.png" id="logo"></a></div>
			<div id="login" class="col-xs-4 col-xs-offset-1">
				<ul>
					<li><a href="usersigninforGatherPoll.php">LOGIN</a></li>
		...
		<section class="row" id="banner">
			<div class="col-xs-12">
					<img src="Styling/images/main_image_notext.png" id="main" class="img-responsive" />
					<div id="main_message">
						<p class="big_text">begin gathering</p><p class="big_text">with purpose</p><p class="subtext">create you own gathering now</p>
						<a href="#"><img src="Styling/images/signup.png" /></a>
					</div>
			</div>
		</section>
		<section class="row">
	...
	<section class="row" id="icons">
			<div id="first" class="col-sm-3 col-xs-6 col-xs-offset-3">
				<div class="img_box">
					<img src="Styling/images/Icon1.png" class="icon"/>
				</div>
			...
			<div class="col-sm-3 col-sm-offset-1 col-xs-6 col-xs-offset-3">
				<div class="img_box">
					<img src="Styling/images/Icon2.png" class="icon"/>
				</div>
...
ALL IN  ONE SPOT</p>
			...
			<div class="col-sm-3 col-sm-offset-1 col-xs-6 col-xs-offset-3">
				<div class="img_box">
					<img src="Styling/images/Icon3.png" class="icon" />
				</div>
    ...
    <!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
        <script>
            alert ("Welcome to Gather! Please click the log in button at the top left to go and view your gathering");
        </script>
