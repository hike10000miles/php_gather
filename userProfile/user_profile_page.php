...
<div class="container">
    ...
    <main class="userProfile">
        ...
        <div class="row" id="buttonRow">
            <div class="col-lg-5 col md-5  col-sm-12 col-xs-12" id="buttonColumn">
            ...
            <div class="col-lg-7 col-sm-12 col-md-12 col-xs-7" id="lorempixem">
                <img title="profile image" class="img-responsive" src="http://lorempixel.com/850/300/sports">
            </div>
